...
#endif
__kernel void transposeF1 ( __global const double2* u,__global double2* v, const int xdiff, const int ydiff, const int Nx)
{
	...
	v[ind].x=u[i+j*Nx+n*xdiff].x;
	v[ind].y=u[i+j*Nx+n*xdiff].y;
}
